...
/obj/item/stack/medical/wrap/sticky_tape/surgical/augment
	name = "integrated surgical tape"
	desc = "A compact surgical tape dispenser fed from an arm-mounted implant."
	amount = 1
	max_amount = 1
	merge_type = /obj/item/stack/medical/wrap/sticky_tape/surgical/augment
	toolspeed = 0.5

/obj/item/stack/medical/wrap/sticky_tape/surgical/augment/use(used, transfer = FALSE, check = TRUE)
	return TRUE
